...
<title>商品出库查询</title>
<meta name="description" content="这是一个商品出库查询页面">
...
<div class="admin-biaogelist" style="position: static;">
    ...
    <div class="listbiaoti am-cf">
      <ul><img style="margin:-5px 5px 0px 0px;" src="<c:url value='/img/index/menu6.png'/>"> 商品出库查询</ul>
      <dl class="am-icon-home" style="float: right;">当前位置： 首页 > <a href="#">商品出库查询</a></dl>
      <!--这里打开的是新页面-->
    </div>
    <div class="am-btn-toolbars am-btn-toolbar am-kg am-cf">
      <form id="search" action="<c:url value='/good/outdepodList.action'/>" method="post">
          ...
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped am-table-hover">
             <thead>
              <tr class="am-success">
                ...
                <th class="table-type" style="text-align:center;">出库时间</th>
                <th class="table-type" style="text-align:center;">领取人</th>
                <th class="table-type" style="text-align:center;">所属部门</th>
            ...
            <c:forEach items="${pageBean.list }" var="good" varStatus="Status">
              <tr>
                ...
                <td>${good.price }</td>
                <td>${good.num }</td>
                <td><fmt:formatDate value="${good.outdepodtime }" pattern="yyyy-MM-dd hh:mm:ss"/></td>
                <td>${good.responsible }</td>
                <td>${good.usedepartment }</td>
