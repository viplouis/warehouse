...
<body >
    	...
    	<div class="listbiaoti am-cf">
	      <ul><img style="margin:-5px 5px 0px 0px;" src="<c:url value='/img/index/menu9.png'/>"> 角色及权限管理</ul>
		      
		      <dl class="am-icon-home" style="float: right;">当前位置： 首页 > <a href="#">角色及权限管理</a></dl>
					...
					<c:forEach items="${paging.list }" var="g">
						<tr>
							...
							<td align="center">
								...
								<a href="javascript:void(0)" onclick="deletegoup('${g.userclassid}')">删除</a>
							</td>
						</tr>
					</c:forEach>
					<tr>
