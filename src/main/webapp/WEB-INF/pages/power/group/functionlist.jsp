...
<body>
	<div style="float:left; width: 50%;margin-bottom: 15px;margin-top: 15px" align="left">
		角色权限列表
	</div>
	<div  style="float:left; width: 50%;margin-bottom: 15px;margin-top: 15px;padding-right: 10px" align="right">
	...
	<span style="float: left;">角色名:${group.userclassname }</span>
