...
<html>
	...
	<body>
    	...
    	<div class="listbiaoti am-cf">
	      <ul><img style="margin:-5px 5px 0px 0px;" src="<c:url value='/img/index/menu9.png'/>"> 部门列表</ul>
		      
		      <dl class="am-icon-home" style="float: right;">当前位置： 首页 > <a href="#">部门列表</a></dl>
		 ...
		 <form  id="myform" action="${pageContext.request.contextPath }/dept/list.action" method="post">    
		  ...
		  <ul>   
		    <li><input type="text" name="sname"class="gjz-quq" class="am-form-field am-input-sm am-input-xm" placeholder="关键词搜索" value="${sname}"/></li>
