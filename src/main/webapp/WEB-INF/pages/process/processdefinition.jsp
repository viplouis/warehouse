...
<style type="text/css">
	...
	<body>
		...
		<div class="am-u-sm-12">
			<form class="am-form am-form-horizontal" action="${pageContext.request.contextPath }/process/processdefinitionSubmit.action" method="post">
				  <div class="am-form-group">
				    <label for="doc-ipt-3" class="am-u-sm-4 am-form-label">流程名称</label>
				    <div class="am-u-sm-4">
				      <input type="text" id="doc-ipt-3" name="processname" placeholder="输入流程名称">
				    </div>
				      	...
				      	<select name="authority1">
				      		<option value="">--请选择审批人--</option>
				      			<c:forEach items="${userlist }" var="user">				      	
				      				<option value="${user.id }" name="${user.unitid}">${user.realname}</option>
				      			</c:forEach>
				      	</select>
				   	</div>
				   	<div class="am-u-sm-6"></div>
