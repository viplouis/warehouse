...
<body>
    ...
    <div class="listbiaoti am-cf">
      <ul class="am-icon-flag on">修改仓库办公用品信息</ul>
      
      <dl class="am-icon-home" style="float: right;"> 当前位置： 首页 >仓库管理> <a href="#">修改仓库办公用品信息</a></dl>
    ...
    <div class="fbneirong">
      <form id="myform" action="${pageContext.request.contextPath }/good/update.action" method="post">
      <input id="text" type="hidden" name="textjosn" value="">
      	<table class="am-table am-table-bordered">
      		<tr>
      			<td class="am-text-cente">编号</td>
      			<td><input type="text" class="am-form-field am-radius"value="${good.goodid }" readonly='readonly	'  name="goodid" /></td>
      		</tr>
      		<tr>
